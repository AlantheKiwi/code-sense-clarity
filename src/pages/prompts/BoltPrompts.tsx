...
const BoltPrompts = () => {
  ...
  const prompts = [
    {
      id: 1,
      title: 'Generate Full-Stack Application with AI Assistance',
      description: 'Use AI-powered coding to create complete applications quickly and efficiently',
      difficulty: 'Beginner',
      rating: 4.8,
      verified: true,
      useCase: 'Full-stack development, rapid prototyping',
      tags: ['full-stack', 'ai-coding', 'typescript'],
      prompt: `Create a full-stack [APP_TYPE] application:

1. **Frontend:** Modern React with TypeScript and Tailwind CSS
2. **Backend:** Node.js API with proper error handling and validation  
3. **Database:** Choose appropriate database with proper schema design
4. **Authentication:** Secure user auth with JWT or OAuth integration
5. **Deployment:** Production-ready configuration with environment variables

Generate clean, well-documented code with proper file structure. Include basic testing setup.`,
      whyItWorks: "Leverages Bolt's AI coding capabilities for complete application generation."
    }
  ];
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-white">Bolt (StackBlitz) Prompts</span>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-black/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10 mb-8">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">Bolt (StackBlitz)</h1>
                <p className="text-white/70">AI coding assistant for rapid prototyping</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-white/60">Coding Assistant</div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-12">
            <div className="bg-black/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              ...
              <p className="text-white/70 mb-6">
                We're creating more Bolt prompts for advanced TypeScript patterns, API integration, performance optimization, and deployment strategies.
              </p>
