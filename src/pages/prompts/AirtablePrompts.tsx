...
import { Search, Copy, Download, Star, ArrowLeft, CheckCircle, Flag } from "lucide-react";
...
const AirtablePrompts = () => {
  ...
  const prompts = [
    {
      id: 1,
      title: 'Design Scalable Database with Automation Rules',
      description: 'Create efficient Airtable bases with proper relationships and automated workflows',
      difficulty: 'Intermediate',
      rating: 4.7,
      verified: true,
      useCase: 'Database design, workflow automation',
      tags: ['database', 'automation', 'relationships'],
      prompt: `Design an Airtable base for [BUSINESS_TYPE]:

1. **Table relationships:** Use linked records and lookup fields appropriately
2. **Field types:** Choose optimal field types for data integrity and usability
3. **Views and filters:** Create useful views for different user roles and purposes  
4. **Automations:** Set up triggered actions for common workflow steps
5. **Permissions:** Configure proper sharing and collaboration settings

Focus on scalability and ease of use. Document the base structure for team members.`,
      whyItWorks: "Based on Airtable's database design best practices and automation capabilities."
    }
  ];
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-white">Airtable Prompts</span>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-black/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10 mb-8">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">Airtable</h1>
                <p className="text-white/70">Database and workflow management platform</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-red-400">4.7</div>
                <div className="text-white/60">Average Rating</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-400">Database</div>
          ...
          <div className="text-center mt-12">
            <div className="bg-black/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              ...
              <p className="text-white/70 mb-6">
                We're developing comprehensive Airtable prompts for complex formulas, advanced automations, API integrations, and team collaboration workflows.
              </p>
...
export default AirtablePrompts;
